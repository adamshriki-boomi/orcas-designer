...
export const MANDATORY_SKILLS: MandatorySkill[] = [
  ...
  { name: 'test-driven-development', category: 'Superpowers', description: 'TDD workflow for features and bugfixes', invocation: '/test-driven-development', repoUrl: MARKETPLACE_REPO, includeCondition: 'never' },
  ...
  { name: 'finishing-a-development-branch', category: 'Superpowers', description: 'Complete development work with merge/PR options', invocation: '/finishing-a-development-branch', repoUrl: MARKETPLACE_REPO, includeCondition: 'never' },
...
export const WIZARD_STEPS = [
  ...
  { key: 'figma-link', label: 'Figma File', required: true },
