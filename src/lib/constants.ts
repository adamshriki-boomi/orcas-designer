...
export const MANDATORY_SKILLS: MandatorySkill[] = [
  ...
  // Design System
  { name: 'exosphere', category: 'Design System', description: 'Official Boomi Exosphere skill — 80 indexed Ex* components, --exo-* design tokens, patterns, and content-guidelines. Auto-triggers on Ex* identifiers, @boomi/exosphere imports, and --exo-* tokens.', invocation: '/exosphere', repoUrl: 'https://github.com/adamshriki-boomi/exosphere-claude-skill', includeCondition: 'always' },
